...
//    }
    ...
    func frequencyInSlotOf(_ chunk: Chunk) -> Int {
        var freq = 0
//        if(self.name == "mf18") {
//            print(chunk)
//        }
...
//        }
    ...
    func sjiWithoutLog(_ chunk: Chunk) -> Double {
        //if self.name == "mf12" {
         //   print("fanTrudy:")
         //   print(self)
         //   print(Double(self.fan))
    ...
    /**
     ...
     - returns: the Sji value
     */
    func freqNiCj(_ valchunk: Chunk) -> Int {
...
//    }
    ...
    */
    func alSpreadingFromBuffer(_ bufferName: String, assocValue: Double) -> Double {
